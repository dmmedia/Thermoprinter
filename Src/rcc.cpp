...
StatusTypeDef RCC_OscConfig(RCC_OscInitTypeDef  *RCC_OscInitStruct)
{
  ...
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSE) == RCC_OSCILLATORTYPE_HSE)
  {
    ...
    {
      if((RCC_GetFlag(RCC_FLAG_HSERDY) != RESET) && (RCC_OscInitStruct->HSEState == RCC_HSE_OFF))
      {
        return STATUS_ERROR;
      }
    }
  ...
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI) == RCC_OSCILLATORTYPE_HSI)
  {
       ...
       || ((RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_PLLCLK) && (RCC_GET_PLL_OSCSOURCE() == RCC_PLLSOURCE_HSI)))
    {
      ...
      if((RCC_GetFlag(RCC_FLAG_HSIRDY) != RESET) && (RCC_OscInitStruct->HSIState != RCC_HSI_ON))
      {
        return STATUS_ERROR;
      }
  ...
  if(((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_MSI) == RCC_OSCILLATORTYPE_MSI)
  {
    ...
    {
      if((RCC_GetFlag(RCC_FLAG_MSIRDY) != RESET) && (RCC_OscInitStruct->MSIState == RCC_MSI_OFF))
      {
        return STATUS_ERROR;
      }
...
StatusTypeDef RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
     ...
     )
  {
    ...
    { // Check HSE State
      if (((PeriphClkInit->RTCClockSelection & RCC_CSR_RTCSEL) == RCC_CSR_RTCSEL_HSE) && isBitSet(RCC->CR, RCC_CR_HSERDY))
      {
   ...
   case RCC_PERIPHCLK_USB:
	{
		...
		else if((srcclk == RCC_USBCLKSOURCE_HSI48) && (isBitSet(RCC->CRRCR, RCC_CRRCR_HSI48RDY)))
		{
  ...
  case RCC_PERIPHCLK_USART1:
	{
	  ...
	  else if ((srcclk == RCC_USART1CLKSOURCE_HSI) && (isBitSet(RCC->CR, RCC_CR_HSIRDY)))
	  {
		frequency = HSI_VALUE;
	  }
	  ...
	  else if ((srcclk == RCC_USART1CLKSOURCE_LSE) && (isBitSet(RCC->CSR, RCC_CSR_LSERDY)))
	  {
		frequency = LSE_VALUE;
	  }
  ...
  case RCC_PERIPHCLK_USART2:
	{
	  ...
	  else if ((srcclk == RCC_USART2CLKSOURCE_HSI) && (isBitSet(RCC->CR, RCC_CR_HSIRDY)))
	  {
		frequency = HSI_VALUE;
	  }
	  ...
	  else if ((srcclk == RCC_USART2CLKSOURCE_LSE) && (isBitSet(RCC->CSR, RCC_CSR_LSERDY)))
	  {
		frequency = LSE_VALUE;
	  }
  ...
  case RCC_PERIPHCLK_LPUART1:
	{
	  ...
	  else if ((srcclk == RCC_LPUART1CLKSOURCE_HSI) && (isBitSet(RCC->CR, RCC_CR_HSIRDY)))
	  {
		frequency = HSI_VALUE;
	  }
	  ...
	  else if ((srcclk == RCC_LPUART1CLKSOURCE_LSE) && (isBitSet(RCC->CSR, RCC_CSR_LSERDY)))
	  {
		frequency = LSE_VALUE;
	  }
