...
void Planner::reset_acceleration_rates() {
  ...
  max_acceleration_steps_per_s2 = max_acceleration_mm_per_s2 * axis_steps_per_mm;
...
void Planner::set_position_mm_kinematic(const float position) {
