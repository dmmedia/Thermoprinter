...
namespace AdcManager {
	...
	extern int16_t current_temperature_raw;
	extern int16_t current_voltage_raw;
	...
	extern int16_t minttemp_raw;
	extern int16_t maxttemp_raw;
	extern int16_t minttemp;
	extern int16_t maxttemp;

	// Init min and max volt with extreme values to prevent false errors during startup
	extern int16_t mintvolt_raw;
	extern int16_t maxtvolt_raw;
	extern int16_t mintvolt;
	extern int16_t maxtvolt;

	extern volatile bool sens_meas_ready;

	void set_current_sens_raw();

	extern uint16_t raw_temp_value;
	extern uint16_t raw_volt_value;
